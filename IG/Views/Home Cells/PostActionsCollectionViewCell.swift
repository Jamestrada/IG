...
final class PostActionsCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        commentButton.frame = CGRect(x: likeButton.right + 15, y: (contentView.height - size), width: size, height: size)
        shareButton.frame = CGRect(x: commentButton.right + 15, y: (contentView.height - size), width: size, height: size)
    }
